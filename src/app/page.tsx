        ...
        <section className="mx-auto max-w-6xl px-4 py-16 sm:py-20">
          ...
          <AnimarAlVer tipo="stagger" className="mt-10 grid gap-6 sm:grid-cols-2">
            {servicios.map((s) => (
              <article
                key={s.id}
                className="tarjeta tarjeta-interactiva group flex flex-col sm:flex-row items-start justify-between gap-5 p-6 hover:border-laton"
              >
                <div className="flex flex-col sm:flex-row items-start gap-5 w-full">
                  {s.foto_url && (
                    <div className="relative h-28 w-full sm:h-32 sm:w-32 shrink-0 overflow-hidden border-2 border-laton/80 shadow-lg shadow-black/50 group-hover:scale-105 transition-transform">
                  ...
                  <div className="flex-1">
                    <h3 className="font-body text-xl font-bold uppercase tracking-wide text-hueso group-hover:text-laton transition-colors">
                      {s.nombre}
                    </h3>
                ...
                <p className="titulo-display shrink-0 text-3xl sm:text-4xl text-laton group-hover:scale-110 transition-transform self-end sm:self-start">
